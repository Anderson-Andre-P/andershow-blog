...
- [Demo Blog](https://anderson-andre.netlify.app/) - this repo
...
- [A markdown guide](https://anderson-andre.netlify.app/blog/github-markdown-guide)
- [Learn more about images in Next.js](https://anderson-andre.netlify.app/blog/guide-to-using-images-in-nextjs)
- [A tour of math typesetting](https://anderson-andre.netlify.app/blog/deriving-ols-estimator)
- [Simple MDX image grid](https://anderson-andre.netlify.app/blog/pictures-of-canada)
- [Example of long prose](https://anderson-andre.netlify.app/blog/the-time-machine)
- [Example of Nested Route Post](https://anderson-andre.netlify.app/blog/nested-route/introducing-multi-part-posts-with-nested-routing)
...
authors: ['default', 'sparrowhawk']
layout: PostLayout
canonicalUrl: https://anderson-andre.netlify.app/blog/introducing-tailwind-nextjs-starter-blog
---
```
